                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <div class="space-y-4 md:space-y-6" action="#">
                        <div>
                            ...
                            <input v-model="name" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="username" required="">
                        </div>
                        <div>
                        ...
                        <p class="text-right">
                            <button @click="auth.register(name, username, password)"  class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                <span>Sign Up</span>
                            </button>
                        </p>
                    </div>
